...
public class ArrayDemo {
    ...
    public static void ex3() {
        ...
        Arrays.sort(names);
        System.out.println("Sorting array: " + Arrays.toString(names));
    }
    ...
    public static void ex5() {
        ...
        cites[1][0] = "French";
        cites[1][1] = "Paris";
        System.out.println(Arrays.deepToString(cites));
    ...
    public static void ex8() {
        ...
        System.out.println("The array before removing the duplicate elements: " + "\n " + Arrays.toString(arr));
